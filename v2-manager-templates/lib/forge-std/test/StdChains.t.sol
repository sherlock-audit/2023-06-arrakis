...
contract StdChainsTest is Test {
    function testChainRpcInitialization() public {
        ...
        assertEq(
            getChain(1).rpcUrl,
            "https://mainnet.infura.io/v3/7a8769b798b642f6933f2ed52042bd70"
        );
        assertEq(
    ...
    function testSetChainFirstFails() public {
        vm.expectRevert(
            'StdChains setChain(string,Chain): Chain ID 31337 already used by "anvil".'
        );
    ...
    function testCannotSetChain_ChainIdExists() public {
        setChain(
            "custom_chain",
            Chain("Custom Chain", 123456789, "https://custom.chain/")
        );
    ...
    function testSetNoChainId0() public {
        vm.expectRevert(
            "StdChains setChain(string,Chain): Chain ID cannot be 0."
        );
    ...
    function testSetChain_ExistingOne() public {
        ...
        setChain(
            "custom_chain",
            Chain("Modified Chain", 999999999, "https://modified.chain/")
        );
        vm.expectRevert(
